<?php
    ...
    function validar($fallos){
        if(isset($_POST["datos"]) && count($fallos)==0){
            return '<div class="alert alert-success"> El formulario ha sido validado. </div>';
        }
    }

    function mostrar() {
        global $nombre, $apellidos, $biografia, $email, $contrasena;
        ...
        echo "· Imagen: ".$_FILES["imagen"]["tmp_name"]."<br/><br/>";
    }
